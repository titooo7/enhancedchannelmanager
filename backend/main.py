...
@app.post("/api/stream-profiles", tags=["Stream Profiles"])
...
@app.get("/api/ffmpeg/capabilities", tags=["FFMPEG Builder"])
...
@app.post("/api/ffmpeg/probe", tags=["FFMPEG Builder"])
...
@app.post("/api/ffmpeg/validate", tags=["FFMPEG Builder"])
...
@app.post("/api/ffmpeg/generate-command", tags=["FFMPEG Builder"])
...
@app.get("/api/ffmpeg/configs", tags=["FFMPEG Builder"])
async def list_ffmpeg_configs():
    configs = ffmpeg_list_configs()
    return {"configs": configs}


@app.post("/api/ffmpeg/configs", tags=["FFMPEG Builder"], status_code=201)
...
@app.get("/api/ffmpeg/configs/{config_id}", tags=["FFMPEG Builder"])
...
@app.put("/api/ffmpeg/configs/{config_id}", tags=["FFMPEG Builder"])
...
@app.delete("/api/ffmpeg/configs/{config_id}", tags=["FFMPEG Builder"])
...
@app.get("/api/ffmpeg/jobs", tags=["FFMPEG Builder"])
async def list_ffmpeg_jobs():
    jobs = ffmpeg_list_jobs()
    return {"jobs": jobs}


@app.post("/api/ffmpeg/jobs", tags=["FFMPEG Builder"], status_code=201)
...
@app.get("/api/ffmpeg/jobs/{job_id}", tags=["FFMPEG Builder"])
...
@app.post("/api/ffmpeg/jobs/{job_id}/cancel", tags=["FFMPEG Builder"])
...
@app.delete("/api/ffmpeg/jobs/{job_id}", tags=["FFMPEG Builder"])
...
@app.get("/api/ffmpeg/queue-config", tags=["FFMPEG Builder"])
async def get_ffmpeg_queue_config():
    return ffmpeg_get_queue_config()


@app.put("/api/ffmpeg/queue-config", tags=["FFMPEG Builder"])
...
@app.get("/api/ffmpeg/profiles", tags=["FFMPEG Profiles"])
...
@app.post("/api/ffmpeg/profiles", tags=["FFMPEG Profiles"])
...
@app.delete("/api/ffmpeg/profiles/{profile_id}", tags=["FFMPEG Profiles"])
